...
class _DashboardPageState extends State<DashboardPage> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                _showErrorsOnly ? 'Most Challenging Fruits' : 'Per-Fruit Performance',
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: AppColors.textPrimary,
              ...
              SizedBox(
                ...
                child: Container(
                  ...
                  child: _showErrorsOnly
                      ? _buildHardestFruitsList(storage)
                      : _buildPerFruitList(storage, perClassCounts, classNames),
                ),
              ),
            ],
          ),
  ...
  Widget _buildHardestFruitsList(DetectionStorageService storage) {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Errors: ${stat.errorCount} of ${stat.sampleCount} samples',
                    style: const TextStyle(
                      fontSize: 12,
                      color: AppColors.textSecondary,
                    ),
