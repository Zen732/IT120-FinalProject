...
/// A service for classifying images of fruits using a TensorFlow Lite model.
class FruitClassifierService {
  FruitClassifierService._();

  static final FruitClassifierService instance = FruitClassifierService._();
  ...
  Future<void> ensureModelLoaded() async {
    ...
    try {
      /// Loads the TFLite model and fruit labels from assets.
      /// Call this method before using the classifier.
